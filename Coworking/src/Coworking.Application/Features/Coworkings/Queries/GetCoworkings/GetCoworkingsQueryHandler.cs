...
public record GetCoworkingsQuery : IRequest<IEnumerable<CoworkingDto>>;

internal sealed class GetCoworkingsQueryHandler(
    IAppDbContext context,
    IMapper mapper)
    : IRequestHandler<GetCoworkingsQuery, IEnumerable<CoworkingDto>>
{
    public async Task<IEnumerable<CoworkingDto>> Handle(GetCoworkingsQuery request, CancellationToken ct)
    {
