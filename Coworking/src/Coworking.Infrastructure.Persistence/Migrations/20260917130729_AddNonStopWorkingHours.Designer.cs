...
namespace Coworking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260917130729_AddNonStopWorkingHours")]
    partial class AddNonStopWorkingHours
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Coworking.Domain.Entities.Booking", b =>
                {
                    ...
                    b.ToTable("booking", null, t =>
                        {
                            t.HasCheckConstraint("ck_bookings_max_duration", "end_time - start_time <= interval '2160 hours'");
                        });
                });
